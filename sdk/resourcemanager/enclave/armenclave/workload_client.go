...
func (client *WorkloadClient) getHandleResponse(resp *http.Response, successCodes ...int) (WorkloadClientGetResponse, error) {
...
func (client *WorkloadClient) NewListByEnclaveResourcePager(resourceGroupName string, virtualEnclaveName string, options *WorkloadClientListByEnclaveResourceOptions) *runtime.Pager[WorkloadClientListByEnclaveResourceResponse] {
	return runtime.NewPager(runtime.PagingHandler[WorkloadClientListByEnclaveResourceResponse]{
		...
		Fetcher: func(ctx context.Context, page *WorkloadClientListByEnclaveResourceResponse) (WorkloadClientListByEnclaveResourceResponse, error) {
			...
			req, err := client.listByEnclaveResourceCreateRequest(ctx, resourceGroupName, virtualEnclaveName, nextLink, options)
			if err != nil {
			...
			return client.listByEnclaveResourceHandleResponse(resp, http.StatusOK)
		},
		Tracer: client.internal.Tracer(),
	})
}
...
func (client *WorkloadClient) listByEnclaveResourceCreateRequest(ctx context.Context, resourceGroupName string, virtualEnclaveName string, nextLink string, _ *WorkloadClientListByEnclaveResourceOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *WorkloadClient) listByEnclaveResourceHandleResponse(resp *http.Response, successCodes ...int) (WorkloadClientListByEnclaveResourceResponse, error) {
...
func (client *WorkloadClient) NewListBySubscriptionPager(virtualEnclaveName string, options *WorkloadClientListBySubscriptionOptions) *runtime.Pager[WorkloadClientListBySubscriptionResponse] {
	return runtime.NewPager(runtime.PagingHandler[WorkloadClientListBySubscriptionResponse]{
		...
		Fetcher: func(ctx context.Context, page *WorkloadClientListBySubscriptionResponse) (WorkloadClientListBySubscriptionResponse, error) {
			...
			req, err := client.listBySubscriptionCreateRequest(ctx, virtualEnclaveName, nextLink, options)
			if err != nil {
...
func (client *WorkloadClient) listBySubscriptionCreateRequest(ctx context.Context, virtualEnclaveName string, nextLink string, _ *WorkloadClientListBySubscriptionOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
	var req *policy.Request
	var err error
	if firstPage {
...
func (client *WorkloadClient) listBySubscriptionHandleResponse(resp *http.Response, successCodes ...int) (WorkloadClientListBySubscriptionResponse, error) {
